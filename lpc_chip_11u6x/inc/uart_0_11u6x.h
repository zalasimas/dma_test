...
/**
 * @brief	Set Half-duplex mode
 * @param	pUART	: Pointer to selected pUART peripheral
 * @return Nothing
 */
STATIC INLINE void Chip_UART0_HalfDuplexSet(LPC_USART0_T *pUART, bool set)
{
	pUART->HDEN = set;
}
...
STATIC INLINE void Chip_UART0_ConfigDataPlius(LPC_USART0_T *pUART, uint32_t config)
{
	pUART->LCR |= config;
}
